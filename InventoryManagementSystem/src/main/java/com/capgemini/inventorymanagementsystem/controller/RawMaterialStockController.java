...
public class RawMaterialStockController {
		...
		@PostMapping("/rawmaterialstock/manufacturingdate")
		...
		@PostMapping("/rawmaterialstock/expirydate")
		public ResponseEntity<String> UpdateRawMaterialStock2(@RequestBody RawMaterialStock rawmaterialstock) {
			RawMaterialStock t = rawMaterialStockService.updateRawMaterialStock(rawmaterialstock);
			if (t == null) {
		...
		@PostMapping("/rawmaterialstock/qualitycheck")
		public ResponseEntity<String> UpdateRawMaterialStock3(@RequestBody RawMaterialStock rawmaterialstock) {
			RawMaterialStock t = rawMaterialStockService.updateRawMaterialStock(rawmaterialstock);
			if (t == null) {
